...
export class FeedbackTaskPropertySet extends TaskPropertySet {
    ...
    feedbackToFreelancerId: string;
    qualityControlTaskId: string;
    feedbackToFreelancer: FeedbackToFreelancer;
    qualityControlTask: WorkflowTask;
}
